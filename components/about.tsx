...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"단국대학교","period":"2020 - 2025","description":"부동산학과 주전공"},{"icon":"graduation","title":"단국대학교","period":"2024-2026","description":"경영학과 부전공"},{"icon":"book","title":"URID 14-1 우수회원","period":"2025","description":"설명을 입력하세요"}],
