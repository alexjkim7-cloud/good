...
/* eslint-disable */
/* prettier-ignore */
"use client" //이 파일에 대해서는 모든 자동 수정을 멈춤
...
export function Projects() {
    ...
    projects: [{"image":"/uploads/project-0-1765104743536.jpg","video":"","title":"[팀] HSBC 빌딩 모의 IM","description":"URID 실물 IM 대회 우수상 수상"},{"image":"/uploads/project-1765137096107-1765137097601.png","video":"","title":"[개인] 경매 물건 보고서","description":"2024 타경 69246 물건 / 투자 하이라이트, 입지, 시장, 입찰전략, 투자 리스크 등 다방면으로 분석 / 우수 보고서 선정"},{"image":"/uploads/project-2-1765117903727.png","video":"","title":"[팀] 경기 청년 갭이어","description":"전세사기 예방 어플리케이션- OCR 및 머신러닝을 통한 데이터 기반 프로젝트로, 팀장으로 참여"},{"image":"/uploads/project-1765139645338-1765139646079.png","video":"","title":"[개인] 경매 물건 보고서","description":"2024 타경 69246 물건 / 투자 하이라이트, 입지, 시장, 입찰전략, 투자 리스크 등 다방면으로 분석 / 우수 보고서 선정"},{"image":"/uploads/project-1765139796529-1765139797296.jpg","video":"","title":"[팀] 2023 지역답사 학술대회","description":"[인천 원도심 활성화 방안] 1등 수상"},{"image":"/uploads/project-1765613672090-1765613672705.png","video":"","title":"[팀] 경기 청년 갭이어","description":"전세사기 예방 어플리케이션- OCR 및 머신러닝을 통한 데이터 기반 프로젝트로, 팀장으로 참여"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
                                ...
                                <div className="grid grid-cols-4 gap-2">
                                    {[3, 6, 9, 12].map(num => (
                                        <button
                                            ...
                                            className={`py-2 px-3 rounded-lg border transition-all ${projectsInfo.initialDisplay === num
                                ...
                                <div className="grid grid-cols-4 gap-2">
                                    {[3, 6, 9, 12].map(num => (
                                        <button
                                            ...
                                            className={`py-2 px-3 rounded-lg border transition-all ${projectsInfo.loadMoreCount === num
                                                ? 'bg-primary text-primary-foreground border-primary'
                                                : 'hover:bg-muted'
                                                }`}
                                        >
