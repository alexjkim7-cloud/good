...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    projects: [{"image":"/uploads/project-0-1765104743536.jpg","video":"","title":"[팀] HSBC 빌딩 모의 IM","description":"URID 실물 IM 대회 우수상 수상"},{"image":"/uploads/project-1765137096107-1765137097601.png","video":"","title":"[개인] 경매 물건 보고서","description":"2024 타경 69246 물건 / 투자 하이라이트, 입지, 시장, 입찰전략, 투자 리스크 등 다방면으로 분석 / 우수 보고서 선정"},{"image":"/uploads/project-4-1765137514018.png","video":"","title":"[팀] 2023 지역답사 학술대회","description":"[인천 원도심 활성화 방안] 1등 수상"},{"image":"/uploads/project-1765139645338-1765139646079.png","video":"","title":"[팀] 캠브리지 빌딩 수익구조 개선안","description":"NPV 및 IRR 기반으로 5년 기준 수익구조 개선안 작성"},{"image":"/uploads/project-1765139796529-1765139797296.jpg","video":"","title":"교내 도시 사진전 출전","description":"사진예술연구회 주최 25년 사진전 : BREAK 출전"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
