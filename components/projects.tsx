...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    projects: [{"image":"/uploads/project-0-1765104743536.jpg","video":"","title":"[팀] HSBC 빌딩 모의 IM","description":"URID 실물 IM 대회 우수상 수상"},{"image":"/uploads/project-1765116792990-1765116794598.png","video":"","title":"[팀] 교내 프로젝트: 사업계획서","description":"교내 프로젝트로 사업 계획서 작성 경험으로 경영 전반을 이해"},{"image":"/uploads/project-2-1765117903727.png","video":"","title":"[팀] 경기 청년 갭이어","description":"전세사기 예방 어플리케이션- OCR 및 머신러닝을 통한 데이터 기반 프로젝트로 참여"},{"image":"/uploads/project-1765137096107-1765137097601.png","video":"","title":"[개인] 경매 물건 보고서","description":"[우수 보고서 선정] 2024 타경 69246 물건 / 투자 하이라이트, 입지, 시장, 입찰전략, 투자 리스크 등 다방면으로 분석"},{"image":"/uploads/project-4-1765137514018.png","video":"","title":"[팀] 2023 지역답사 학술대회","description":"[인천 원도심 활성화 방안] 1등 수상"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
