...
export function Projects() {
    ...
    projects: [{"image":"/uploads/project-0-1765104743536.jpg","video":"","title":"[팀] HSBC 빌딩 모의 IM","description":"URID 실물 IM 대회 우수상 수상"},{"image":"/uploads/project-1765137096107-1765137097601.png","video":"","title":"[개인] 경매 물건 보고서","description":"2024 타경 69246 물건 / 투자 하이라이트, 입지, 시장, 입찰전략, 투자 리스크 등 다방면으로 분석 / 우수 보고서 선정"},{"image":"/uploads/project-2-1765632675407.png","video":"","title":"[팀] 경기 청년 갭이어","description":"전세사기 예방 어플리케이션- OCR 및 머신러닝을 통한 데이터 기반 프로젝트로, 팀장으로 참여"},{"image":"/uploads/project-1765632702858-1765632702888.jpg","video":"","title":"[팀] 지역답사 학술대회 우승","description":"2024 타경 69246 물건 / 투자 하이라이트, 입지, 시장, 입찰전략, 투자 리스크 등 다방면으로 분석 / 우수 보고서 선정"},{"image":"/uploads/project-4-1765632909116.png","video":"","title":"[팀] 캠브리지 빌딩 수익타당성 분석 프로젝트","description":"[인천 원도심 활성화 방안] 1등 수상"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
